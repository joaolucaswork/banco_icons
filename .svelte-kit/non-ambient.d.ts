...
declare module "$app/types" {
	export interface AppTypes {
		RouteId(): "/" | "/como-e-porque" | "/icon-controller" | "/style-guide";
		RouteParams(): {
			
		};
		LayoutParams(): {
			"/": Record<string, never>;
			"/como-e-porque": Record<string, never>;
			"/icon-controller": Record<string, never>;
			"/style-guide": Record<string, never>
		};
		Pathname(): "/" | "/como-e-porque" | "/como-e-porque/" | "/icon-controller" | "/icon-controller/" | "/style-guide" | "/style-guide/";
