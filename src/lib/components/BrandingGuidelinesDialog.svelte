...
<button
  ...
  style="all: unset !important; cursor: pointer !important; display: inline-block !important;"
  onclick={openDialog}
  {...restProps}
>
  <TriangleAlertIcon
    class="h-5 w-5 text-yellow-500 drop-shadow-lg"
  ...
  >
    ...
    <div class="space-y-6">
      <p class="text-sm text-foreground">
        ...
        <strong>exclusivamente em aplicações internas</strong>. Para aplicações
        públicas, sempre utilize as cores oficiais da marca.
      </p>

      <p class="text-sm text-foreground">
        A manutenção da consistência visual é essencial para o reconhecimento da
        marca e a confiança do usuário. Alterações nas cores oficiais podem
      ...
      >
        <CardContent class="p-4">
          <div class="flex items-start gap-3">
            ...
            />
            <div>
              <h3 class="mb-2 font-medium text-yellow-900 dark:text-yellow-100">
                Aviso Importante
              </h3>
